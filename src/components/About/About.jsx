...
const About = () => {
  return (
    ...
    <Header></Header>
      ...
      <p className="text-gray-700 leading-relaxed mb-4">
        The platform allows faculty, students, and external visitors to browse through categorized projects, read abstracts, explore technologies used, and understand
        innovative ideas implemented by students. Our aim is to preserve student innovations and inspire future learners.
      </p>
